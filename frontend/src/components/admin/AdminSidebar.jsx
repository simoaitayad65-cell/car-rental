...
export default function AdminSidebar({ onNavigate }) {
  ...
  return (
    <div className="flex h-full flex-col bg-white dark:bg-slate-900">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 rounded-lg border-l-2 px-3 py-2.5 text-sm font-medium transition-colors ${
                isActive
                  ? "border-amber-500 bg-violet-50 text-violet-700 dark:bg-violet-500/10 dark:text-violet-400"
      ...
      <div className="space-y-1 border-t border-stone-200 px-3 py-4 dark:border-slate-800">
        <button
          type="button"
          onClick={toggleTheme}
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
        >
        ...
        <div className="mt-3 flex items-center gap-2 border-t border-stone-200 px-3 pt-3 dark:border-slate-800">
